...
func TestPersist22C(t *testing.T) {
	...
	for iters := 0; iters < 5; iters++ {
		...
		fmt.Printf("-------------- current servers ALL    , val= %d------------\n", 10+index)
		...
		fmt.Printf("-------------- current servers %d %d %d, val= %d------------\n", (leader1 + 0) % servers, (leader1 + 3) % servers, (leader1 + 4) % servers, 10+index)
		...
		fmt.Printf("-------------- current servers %d %d %d, val= %d------------\n", (leader1 + 1) % servers, (leader1 + 2) % servers, (leader1 + 3) % servers, 10+index)
