...
for i in range(500):
    ...
    # os.system("echo \'========= %d over =========\n\' >> outputlog.txt " %i)
    os.system("echo \'========= %d =========\n\' >> outputlog.txt " %i)
    # os.system("go  test -run 2A  >> outputlog.txt ")
    # os.system("go  test -run 2B  >> outputlog.txt ")
    os.system("go  test -run 2C  >> outputlog.txt ")
    os.system("go  test -run 2D  >> outputlog.txt ")
    os.system("echo \'========= %d over =========\n\' >> outputlog.txt " %i)